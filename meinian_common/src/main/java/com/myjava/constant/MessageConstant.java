...
public class MessageConstant {
    ...
    public static final String EDIT_SETMEAL_SUCCESS = "套餐修改成功";
    public static final String EDIT_SETMEAL_FAIL = "套餐修改失败";
    ...
    public static final String QUERY_ORDER_FAIL_NULL = "查询预约信息为空";
    ...
    public static final String DELETE_TRAVELITEMFORID_FAIL = "存在关联数据，删除失败";
    public static final String GET_GUAN_LIAN_SHU_JU_FAIL = "查询数据失败，请刷新页面后重试!";
    public static final String DELETE_ZHONG_JIAN_BIAO_FAIL = "删除中间表失败";
