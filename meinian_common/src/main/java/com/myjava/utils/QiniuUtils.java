...
public class QiniuUtils {
    ...
    public static String accessKey = "1youzYs1KZG_NKzumi_jEPwe_wJfkTElYaDzEeuc";
    public static String secretKey = "kLB65IcFFrLtaAgfg5pc5GbcnxVMbERlCNjAWex3";
    public static String bucket = "mykj0921";
